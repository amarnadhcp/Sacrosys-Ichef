...
function LeftBar() {
  return (
    <div className="flex flex-col bg-[#673074] items-center justify-center text-[9px] lg:text-xs text-white font-poppins h-full rounded-l-3xl">
      <div className="mb-2 pb-2 lg:mb-4  lg:pb-4 flex items-center flex-1 my-4 lg:my-6 flex-col border-b border-white w-full">
        <img src={staff} alt="Image 1" className="w-3 h-3 lg:w-4 lg:h-4" />
        <span className="mt-1">Staff</span>
      </div>
      <div className="mb-2 pb-2 lg:mb-4 lg:pb-4 flex items-center flex-1  flex-col border-b border-white w-full ">
      ...
      <div className="mb-2 pb-2 lg:mb-4 lg:pb-4 flex items-center flex-1  flex-col w-full mt-2">
